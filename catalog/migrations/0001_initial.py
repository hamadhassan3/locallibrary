# Generated by Django 3.2.4 on 2021-06-16 10:36
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('language', models.CharField(help_text='Enter a book genre (e.g. Science Fiction)', max_length=100)),
            ],
            options={
                'ordering': ['language'],
            },
        ...
        migrations.AddField(
            model_name='book',
            name='language',
            field=models.OneToOneField(help_text='Select a language for this book', on_delete=catalog.models.Language, to='catalog.language'),
        ),
    ]
