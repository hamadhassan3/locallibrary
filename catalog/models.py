""" catalog models for data storage

The models are defined as classes for every real world object needed in
the system. Each model class needs to inherid from django.db.models.Model.
The methods for CRUD (create, read, update and delete) are inherited from
the super class.
"""
...
class Language(CatalogModel):
    ...
    language = models.CharField(
        max_length=100,
        help_text="Enter a language for the book (e.g. English)",
        blank=False,
    )
...
class BookInstance(CatalogModel):
    ...
    class Meta:
        ...
        # These permissions give access to specific functionalities
